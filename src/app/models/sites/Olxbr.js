...
class Olxbr {
    ...
    static get results() {
        return '#main-ad-list .item:not(.list_native)';
    }

    static get title() {
        return '.OLXad-list-title';
    }

    static get price() {
        return '.OLXad-list-price';
    }
    ...
    static async getAdverts(filter, responseToEmail) {
        ...
        try {
            ...
            itens.forEach(item => {
                ...
                responseToEmail.push(
                    Common.getResponseToEmail(
                        ...
                        thumb !== null ? this.getSrcImg(thumb) : '',
                        link
                    )
                );
            });
            ...
            // Get next page
            const nextPage = this.getLinkNextPage(document);
    ...
    static getSrcImg(thumb) {
        return thumb.getAttribute('data-original') != null
